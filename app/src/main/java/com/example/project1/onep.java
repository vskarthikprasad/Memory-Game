...
public class onep extends AppCompatActivity {
    ...
    int  firstcard,secondcard,clickedfirst,clickedsecond,cardno=1,turn=1,ppnts=0;
    ...
    private void checkEnd()
    {
                ...
                iv_33.getVisibility() == View.INVISIBLE && iv_34.getVisibility() == View.INVISIBLE)
        {
            ...
            AlertDialog.Builder alrtdlgbld = new AlertDialog.Builder(onep.this);
            alrtdlgbld
                    ...
                    .setPositiveButton("New Game", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Intent intent = new Intent(getApplicationContext(),onep.class);
                    ...
                    .setNegativeButton("Back", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(onep.this , LoginActivity.class);
                            startActivity(intent);
                            onep.this.finish();
    ...
    {
        Intent i = new Intent(onep.this , ModeOptionActivity.class);
        startActivity(i);
        onep.this.finish();
